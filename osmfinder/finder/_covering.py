"""
Internal geometry-covered extract selection.

This module contains the pure geometry-covering algorithm that, given an index of
OSM extracts, finds the smallest set of extracts covering an input geometry. It does
not depend on the package :mod:`osmfinder.finder` namespace and holds no
package-namespace-patchable state of its own, so its call-sites reference their
siblings directly within this module.
"""
...
from osmfinder._results import GeometryCoveringStep
